  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": { "0%, 100%": { boxShadow: "0 0 5px hsl(var(--primary) / 0.3)" }, "50%": { boxShadow: "0 0 20px hsl(var(--primary) / 0.5)" } },
        "slide-from-phone": { "0%": { opacity: "0", transform: "translate(0, 0) scale(0.8)" }, "50%": { opacity: "0.5" }, "100%": { opacity: "1", transform: "translate(var(--target-x), var(--target-y)) scale(1)" } },
        "rise-float": { "0%": { transform: "translateY(0)", opacity: "0" }, "8%": { transform: "translateY(-48px)", opacity: "1" }, "82%": { transform: "translateY(-492px)", opacity: "1" }, "96%": { transform: "translateY(-576px)", opacity: "0" }, "100%": { transform: "translateY(-600px)", opacity: "0" } },
        "scrollUp": { "0%": { transform: "translateY(0%)" }, "100%": { transform: "translateY(-33.333%)" } },
